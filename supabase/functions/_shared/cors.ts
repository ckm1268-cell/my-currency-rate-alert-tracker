...
// GitHub Pages URL below (same pattern as APP_URL in backend/
// notifications/notify.js — see ADMIN_SETUP.md).

const ALLOWED_ORIGIN =
  Deno.env.get("ALLOWED_ORIGIN") ?? "https://ckm1268-cell.github.io";
